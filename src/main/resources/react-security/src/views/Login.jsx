        ...
        <>
            <div
                ...
                <form className="space-y-6" onSubmit={(e) => {e.preventDefault();
                    httpClient.authenticate("auth/authenticate",Object.fromEntries(new FormData(e.target).entries())).then(() => navigate("/"))
                }}>
                    ...
                    <div className="flex items-start">
                        <div className="flex items-start">
                            <div className="flex items-center h-5">
                                <input id="remember" type="checkbox" name="remember" onChange={(e) => e.target.value = e.target.checked}
